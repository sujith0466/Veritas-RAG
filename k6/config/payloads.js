/**
 * RAGuard V2 k6 Payloads & Fixtures
 */

export const SAMPLE_PROMPTS = [
  'What are the compliance requirements for GDPR document retention?',
  'Explain the multi-tenant architecture and isolation guarantees of RAGuard.',
...
export function generateDummyDocument(sizeKb = 50) {
  const content = 'RAGuard enterprise compliance document test content. '.repeat(sizeKb * 15);
  return {
