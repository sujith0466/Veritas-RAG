...
This directory contains the required documentation deliverables for Round-1 of the RAGuard AI project submission.

## Purpose of Each File
- `Product-Requirements-Document-PRD-RAGuard-AI.md`: The main Product Requirements Document detailing features, scopes, and product design.
- `Architecture Copilot PDF`: The exported architecture diagram representing the system's high-level components and flow.
