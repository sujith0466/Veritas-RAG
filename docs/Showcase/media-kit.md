...
- Maintain a clear space of at least 20% around the logo.
- Do not stretch, skew, or alter the brand colors (Teal #009688).

## Screenshot Reference
*(Placeholders located in `docs/Assets/`)*
- `grafana_dashboard.png`: Use to demonstrate observability.
- `postman_response.png`: Use to demonstrate the JSON structure and confidence scoring.
