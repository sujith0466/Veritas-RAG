...
class VectorEventPayload(BaseModel):
    ...
    event_type: str = Field(
        description="Name of the domain event (`vector.indexed` or `vector.index_failed`)"
    )
    timestamp: str = Field(
    ...
    data: dict[str, Any] = Field(
        ...
        description="Event-specific payload metrics (`points_count`, `dimension`, or `error_code`)",
    )
