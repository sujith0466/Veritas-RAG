...
class GenerationFailed(GenerationDomainException):
    def __init__(
        self, message: str = "Answer generation failed", detail: dict | None = None
    ):
        super().__init__(
            message=message,
...
class CitationExtractionFailed(GenerationDomainException):
    def __init__(
        self, message: str = "Citation extraction failed", detail: dict | None = None
    ):
        super().__init__(
            message=message,
            error_code=GenerationErrorCode.CITATION_EXTRACTION_FAILED,
            detail=detail,
        )
...
class GroundingViolation(GenerationDomainException):
    ...
    def __init__(
        self,
        message: str = "Grounding violation: answer contains uncited claims",
        detail: dict | None = None,
    ):
        super().__init__(
            message=message,
            error_code=GenerationErrorCode.GROUNDING_VIOLATION,
            detail=detail,
        )
