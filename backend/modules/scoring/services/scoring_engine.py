import os
from backend.modules.scoring.schemas.scoring_dto import ScoringRequestDTO, ReliabilityScoreDTOv2
...
class ScoringEngine:
    ...
    async def calculate_score(self, request: ScoringRequestDTO) -> ReliabilityScoreDTOv2:
