...
class CoverageAnalyzer:
    ...
    def __init__(self):
        ...
        self.clause_delimiters = re.compile(
            r"\b(?:and|or|but|because|if|then|when|where)\b|[.,;?!]"
        )
