...
class DocumentEventRepository:
    ...
    async def append_event(self, event_log: DocumentEventLog, session: AsyncSession) -> DocumentEventLog:
    ...
    async def list_by_document(
        ...
        stmt = (
            ...
            .where(DocumentEventLog.document_id == document_id, DocumentEventLog.is_deleted.is_(False))
