...
EVENT_DOCUMENT_ARCHIVED = "DocumentArchived"
EVENT_DOCUMENT_RESTORED = "DocumentRestored"
EVENT_DOCUMENT_VERSION_CREATED = "DocumentVersionCreated"
EVENT_DOCUMENT_ROLLED_BACK = "DocumentRolledBack"
