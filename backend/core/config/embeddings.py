...
class EmbeddingSettings(BaseSettings):
    ...
    openai_model: str = Field(default="text-embedding-3-large", alias="OPENAI_EMBEDDING_MODEL")
    cohere_api_key: str = Field(default="", alias="COHERE_API_KEY")
    cohere_model: str = Field(default="embed-multilingual-v3.0", alias="COHERE_EMBEDDING_MODEL")
    local_model: str = Field(default="BAAI/bge-large-en-v1.5", alias="LOCAL_EMBEDDING_MODEL")
